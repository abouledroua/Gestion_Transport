...
class DrawerMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Drawer(
        ...
        const DrawerListTile(
            title: 'Clients', icon: Icons.person_2_outlined, myIndex: 4),
        const DrawerListTile(
            title: 'Fournisseurs',
        ...
        const Padding(
            ...
            child: Divider(color: grey, thickness: 0.2)),
        const DrawerListTile(
            title: 'Caisse', icon: Icons.attach_money_outlined, myIndex: 7),
        const DrawerListTile(
            title: 'Paramêtres', icon: Icons.settings, myIndex: 8),
        DrawerListTile(
            title: 'Logout', icon: Icons.logout, color: red, myIndex: 9)
      ]));
}
